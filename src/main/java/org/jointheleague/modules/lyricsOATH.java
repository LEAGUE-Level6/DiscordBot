...
public class lyricsOATH
{
    ...
    /**
     * Constructs a new {@link lyricsOATH} using all defaults
     */
    public lyricsOATH()
    {
        this(null, null);
    ...
    /**
     * Constructs a new {@link lyricsOATH}, specifying the default source
     * for lyrics
     * 
     * @param defaultSource the default source for lyrics
     */
    public lyricsOATH(String defaultSource)
    {
        this(defaultSource, null);
    }
    
    /**
     * Constructs a new {@link lyricsOATH}, specifying an {@link Executor}
     * to be used for making {@link CompletableFuture}s
     * 
     * @param executor the executor to use internally
     */
    public lyricsOATH(Executor executor)
    {
        this(null, executor);
    }
     ...
     * @param executor the executor to use internally
     */
    public lyricsOATH(String defaultSource, Executor executor)
    {
