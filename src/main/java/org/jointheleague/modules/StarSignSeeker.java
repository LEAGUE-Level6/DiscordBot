...
public class StarSignSeeker extends CustomMessageCreateListener {
	...
	public void handle(MessageCreateEvent event) {
		...
		if(a.equals("!fortune")) {
			...
			interaction = 1;
			event.getChannel().sendMessage("~Greetings, "+event.getMessageAuthor().getName() + ", I will tell you your star sign and make a prediction about you. Tell me, what is your birth month?");
		}
		else if (interaction==1) {
				month = event.getMessageContent();
				event.getChannel().sendMessage("Understood... Give me a moment as I stargaze and calibrate your sign...");
